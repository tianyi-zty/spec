...
def main():
    filename = f'10'
    before_collagen = r'../data/AuPillars_50nmAl2O3_2_05222025/before/LMR_1.mat'
    after_collagen = r'../data/AuPillars_50nmAl2O3_2_05222025/after_1/LMR_5.mat'
    save_path = f'../res/AuPillars_50nmAl2O3_2_05222025/{filename}'
