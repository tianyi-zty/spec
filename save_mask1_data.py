...
def main():
    foldername_list = ['1000B','1000','9010','8020','7030','6040'] #['8020'] #
    filename_list = ['LMT_1','LMT_2','LMT_3','LMT_4']
    for foldername in foldername_list:
        for filename in filename_list:
            ...
            after_collagen = f'W:/3. Students/Tianyi/Caf2_06262025/{foldername}/{filename}'+'.mat'
            save_path = f'../res/Caf2_06262025_tnse/original/{foldername}/{filename}/'
            ...
            fig, ((ax1, ax2, ax6), (ax3, ax4, ax5)) = plt.subplots(2, 3, figsize=(9, 6))  # Create a 2x2 grid of subplots
            ...
            # print(f"Found {len(valid_spectra)} spectra with Amide I max between 1 and 1.5.")
